...
namespace Osporting.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<Osporting.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<Osporting.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(Osporting.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(Osporting.Server.Models.ApplicationUser user)
        {
            try
            {
