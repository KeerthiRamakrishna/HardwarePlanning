    ...
    public partial class Index
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            try
            {
                ...
                var list1 = ((List<Appointment>)result.Value.Select(x => new Appointment { Start = x.StartDate, End = x.EndDate, Text = x.TestPc.TestPCName +"-" + x.HWevaluationBoard + "-" + x.Person.PersonFirstName + "- StartDate:" + x.StartDate + "- EndDate:" + x.EndDate }).ToList());
                appointments = list1;
